				...
				for (var key in data[i]) {
					...
					if (mini<0){
						if (key == 'exp'){
							...
							var render = reduce_signe(data[i][key]['a'],false, false) + 'e^{' + reduce_signe(-data[i][key]['b'],false) + '('name'+' + delta + ')}' + reduce_signe(data[i][key]['c'],false);
							...
							var render = reduce_signe(data[i][key]['a'], false, false) + "\\log(" + reduce_signe(data[i][key]['b'], false, false) + "("name"+"+ delta + ")" + reduce_signe(data[i][key]['c'],false) + ")" + reduce_signe(data[i][key]['d'],false);
							...
							var render = reduce_signe(data[i][key]['a'], false, false) + "\\frac{("name"+" + delta + ")^{" + reduce_signe(1 - data[i][key]['b'], false) + "}-1}{" + reduce_signe(1 - data[i][key]['b'], false) + "}" + reduce_signe(data[i][key]['c'], false);
							...
							var render = reduce_signe(data[i][key]['c'], false, false) + "("name"+"+delta+")" + reduce_signe(-data[i][key]['b'], false) + "("name"+"+delta+")^{2}" + reduce_signe(data[i][key]['a'], false);
							...
							var render = reduce_signe(data[i][key]['a'], false, false) + "("name"+" + delta + ")" + reduce_signe(data[i][key]['b'], false);
							...
							var render = reduce_signe(data[i][key]['a'], false, false) + "+exp(" + reduce_signe(-data[i][key]['b'], false, false) + "*("name"+"+delta+")^{" + reduce_signe(data[i][key]['c'], false, false) + "})" ;
							var excel = reduce_signe(data[i][key]['a']) + "+EXP(-(" + reduce_signe(data[i][key]['b']) + ")*("name"+"+delta+")^" + reduce_signe(data[i][key]['c']) + ")" ;
							addTextForm(div_function, copie, render, key, excel);
						}
						...
						if (key == 'exp'){
							...
							var render = reduce_signe(data[i][key]['a'],false, false) + 'e^{' + reduce_signe(-data[i][key]['b'],false) + name'}' + reduce_signe(data[i][key]['c'],false);
							...
							var render = reduce_signe(data[i][key]['a'], false, false) + "\\log(" + reduce_signe(data[i][key]['b'], false, false) + name + reduce_signe(data[i][key]['c'],false) + ")" + reduce_signe(data[i][key]['d'],false);
							...
							var render = reduce_signe(data[i][key]['a'], false, false) + "\\frac{"name"^{" + reduce_signe(1 - data[i][key]['b'], false) + "}-1}{" + reduce_signe(1 - data[i][key]['b'], false) + "}" + reduce_signe(data[i][key]['c'], false);
							...
							var render = reduce_signe(data[i][key]['c'], false, false) + name + reduce_signe(-data[i][key]['b'], false) + name"^{2}" + reduce_signe(data[i][key]['a'], false);
							...
							var render = reduce_signe(data[i][key]['a'], false, false) + name + reduce_signe(data[i][key]['b'], false);
							...
							var render = reduce_signe(data[i][key]['a'], false, false) + "+exp(" + reduce_signe(-data[i][key]['b'], false, false) + "*"name"^{" + reduce_signe(data[i][key]['c'], false, false) + "})" ;
							var excel = reduce_signe(data[i][key]['a']) + "+EXP(-(" + reduce_signe(data[i][key]['b']) + ")*"name"^" + reduce_signe(data[i][key]['c']) + ")" ;
							addTextForm(div_function, copie, render, key, excel);
						}
					};
